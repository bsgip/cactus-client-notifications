...
RUN pip install --no-cache-dir "cactus-client-notifications @ git+ssh://git@github.com/bsgip/cactus-client-notifications.git@${CACTUS_CLIENT_NOTIFICATIONS_VERSION}" aiohttp gunicorn
